...
class _CartScreenState extends State<CartScreen> {
                                      ...
                                      children: <Widget>[
                                        Container(
                                          ...
                                          child: ClipOval(
                                            ...
                                            imageUrl:
                                                "https://socbookweb.000webhostapp.com/images/${cartData[index]['id']}.jpg",
  ...
  void _loadCart() {
    ...
    pr.show();
    String urlLoadJobs = "https://socbookweb.000webhostapp.com/load_cart.php";
  ...
  _updateCart(int index, String op) {
    ...
    String urlLoadJobs = "https://socbookweb.000webhostapp.com/update_cart.php";
    http.post(urlLoadJobs, body: {
      "email": widget.user.email,
        ...
        actions: <Widget>[
          MaterialButton(
              onPressed: () {
                ...
                http.post(
                    "https://socbookweb.000webhostapp.com/delete_cart.php",
                    body: {
                      "email": widget.user.email,
                      "prodid": cartData[index]['id'],
                    }).then((res) {
      ...
      builder: (context) => new AlertDialog(
        ...
        actions: <Widget>[
          MaterialButton(
              onPressed: () {
                Navigator.of(context).pop(false);
                http.post(server + "/delete_cart.php", body: {
                  "email": widget.user.email,
                }).then((res) {
                  print(res.body);
